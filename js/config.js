...
window.SITE = {
  ...
  // الشحن
  freeShippingOver: 0, // شحن مجاني فوق المبلغ ده (0 = إلغاء الخاصية) — ملغى
  // ⭐ آراء العملاء (تظهر في الصفحة الرئيسية القطاعية) — عدّلها بآراء حقيقية
  reviews: [
    { name: 'محمود عبد الله', car: 'BMW F30', stars: 5, text: 'قطع أصلية وسعر ممتاز، والتوصيل كان أسرع مما توقعت. تعامل محترم.' },
    { name: 'كريم مصطفى', car: 'MINI Cooper', stars: 5, text: 'لقيت قطعة كنت بدوّر عليها من زمان، وفحصوها قدامي قبل التسليم. تمام.' },
    { name: 'أحمد سمير', car: 'BMW X5', stars: 5, text: 'اسأل الخبير ساعدني أحدد القطعة الصح، ووصلت بالضمان. هكرر التعامل أكيد.' },
  ],
