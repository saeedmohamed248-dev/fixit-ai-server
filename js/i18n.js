...
const I18N = {
  ...
  sav_sub: { ar: 'ارفع آخر فاتورة قطع غيار معاك، والبوت هيقرأها ويقارن أسعارها بأسعارنا ويقولك وفّرت كام.', en: 'Upload your last parts invoice — our bot reads it, compares prices with ours, and shows your savings.' },
  sav_upload: { ar: '📷 ارفع صورة الفاتورة', en: '📷 Upload invoice photo' },
  sav_upload_hint: { ar: 'صورة واضحة للفاتورة (JPG/PNG) — تقدر ترفع لحد ٤ صور لفاتورة من كذا صفحة.', en: 'A clear photo (JPG/PNG) — up to 4 images for a multi-page invoice.' },
  sav_analyze: { ar: 'حلّل الفاتورة', en: 'Analyze invoice' },
  sav_analyzing: { ar: '⏳ بنقرأ الفاتورة ونقارن الأسعار...', en: '⏳ Reading your invoice & comparing prices...' },
  sav_change: { ar: 'صورة تانية', en: 'Change image' },
  sav_result_save: { ar: 'كنت هتوفّر', en: 'You would have saved' },
  sav_result_pct: { ar: 'أقل بنسبة', en: 'cheaper by' },
  sav_their_total: { ar: 'إجمالي فاتورتك (للقطع المتطابقة)', en: 'Your invoice total (matched items)' },
  ...
  sav_by_name: { ar: 'تطابق بالاسم (تقريبي)', en: 'name match (approx.)' },
  sav_unmatched: { ar: 'قطع مالقناهاش في المتجر', en: 'Parts we couldn’t match' },
  sav_unmatched_hint: { ar: 'القطع دي مش متوفرة حالياً أو الاسم مش واضح — اسأل الخبير أو اطلبها.', en: 'Not available now or unclear name — ask the expert or request them.' },
  sav_cheaper_note: { ar: '✅ أسعارك كانت أرخص في القطع المتطابقة — تعامل ممتاز! شوف باقي كتالوجنا برضه.', en: '✅ Your prices were cheaper on the matched parts — nice! Still, browse our catalog.' },
  sav_cta_shop: { ar: 'اطلب القطع دي من فيكس إت 🛒', en: 'Order these from FixIt 🛒' },
  sav_none: { ar: 'مالقيناش بنود قطع واضحة في الصورة — جرّب صورة أوضح للفاتورة.', en: 'No clear part lines found — try a clearer invoice photo.' },
  sav_err: { ar: 'حصل خطأ في التحليل — جرّب تاني بصورة أوضح.', en: 'Analysis failed — try again with a clearer photo.' },
  sav_disabled: { ar: 'الحاسبة مؤقتاً مش متاحة. جرّب لاحقاً.', en: 'The calculator is temporarily unavailable. Try later.' },
  sav_home_cta: { ar: 'عندك فاتورة قطع غيار؟ اعرف كنت هتوفّر كام مع فيكس إت 💰', en: 'Got a parts invoice? See how much you’d save with FixIt 💰' },
